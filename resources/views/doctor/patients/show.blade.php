...
<div class="max-w-7xl mx-auto pb-10">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <a href="{{ route('doctor.dashboard') }}" class="text-teal-600 hover:text-teal-800 flex items-center gap-1 font-medium text-sm transition">
                    ...
                    @forelse($patient->consultations as $consultation)
                        <div class="p-6 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900 transition relative">
                            ...
                            <div class="md:pl-6 relative z-10 w-full">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-lg p-4 shadow-sm mb-4 w-full">
                                    <div>
                                        <p class="text-[10px] uppercase font-bold text-gray-400 tracking-wider">Queue No.</p>
                                        <p class="font-bold text-teal-700 text-base">{{ $consultation->queue_number }}</p>
                                    </div>
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-800 dark:text-white text-sm">
                                            @if($consultation->blood_pressure) {{ $consultation->blood_pressure }} mmHg @else - @endif
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-800 dark:text-white text-sm flex gap-2">
                                            @if($consultation->weight) {{ $consultation->weight }}kg @else - @endif
                                            @if($consultation->bmi)
                                                <span class="px-1.5 py-0.5 rounded text-xs text-white {{ $consultation->bmi < 18.5 ? 'bg-blue-400' : ($consultation->bmi < 25 ? 'bg-green-500' : 'bg-red-400') }}">
                                                    {{ $consultation->bmi }}
                                                </span>
                                            @endif
                                        </p>
