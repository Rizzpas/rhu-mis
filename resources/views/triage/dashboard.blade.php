                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <template x-teleport="body">
                            <div x-show="genericConfirmOpen"
                                 ...
                                 aria-labelledby="triage-confirm-modal-title"
                                 role="dialog"
                                 aria-modal="true">
                                        ...
                                        <div class="p-6 sm:p-8">
                                            <div class="sm:flex sm:items-start">
                                                ...
                                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                    <h3 class="text-xl font-bold text-slate-900 dark:text-white" id="triage-confirm-modal-title" x-text="genericConfirmTitle"></h3>
                                                    <div class="mt-2">
