...
<div class="min-h-[70vh] flex items-center justify-center px-4">
    <div class="text-center">
        <div class="mb-6 relative">
            <span class="text-9xl font-black text-teal-600/20 dark:text-teal-400/10">419</span>
            <div class="absolute inset-0 flex items-center justify-center">
                <svg class="w-20 h-20 text-teal-600 dark:text-teal-400 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
            </div>
        </div>
        <h1 class="text-4xl font-black text-gray-900 dark:text-white mb-4">Page Expired</h1>
        <p class="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto italic">
            "Pasensya na po, nag-expire na ang session."<br>
