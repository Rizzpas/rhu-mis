            ...
            <div x-show="step === 1" x-transition>
                ...
                <form @submit.prevent="sendOtp" class="space-y-5">
                    ...
                    <div class="mt-6 text-center">
                        <a href="{{ route('staff.access') }}" class="inline-flex items-center text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 transition-colors">
