...
<head>
    ...
    <title>RHU - Silang | Doctor Portal</title>
    ...
    <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 leading-tight">Doctor Portal</p>
                </div>
            </div>
        ...
        <nav class="flex-1 px-4 py-4 space-y-0.5 text-sm overflow-y-auto custom-scrollbar">
            <a href="{{ route('doctor.dashboard') }}"
                class="@if(request()->routeIs('doctor.dashboard')) bg-gradient-to-r from-emerald-600 to-emerald-800 text-white shadow-md font-semibold @else text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white @endif group flex items-center px-3 py-2.5 rounded-lg transition-colors">
