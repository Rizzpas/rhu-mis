        ...
        <div @click.away="genericConfirmOpen = false" 
            ...
            <div class="p-6">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white" x-text="genericConfirmTitle"></h3>
                </div>
                <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed" x-text="genericConfirmMessage"></p>
            </div>
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900/50 flex items-center justify-end gap-3 border-t border-gray-100 dark:border-gray-700">
                ...
                <button type="button" 
                        ...
                        class="bg-teal-600 hover:bg-teal-700 text-white font-bold py-2 px-6 rounded-lg shadow-sm transition flex items-center gap-2 text-sm uppercase tracking-wider">
                    Confirm Completion
                </button>
            </div>
        </div>
